...
class CustomerService:
    ...
    def create_customer(self, customer_in: CustomerCreate) -> Customer:
        ...
        """
        existing = self.repository.get_by_phone_number(customer_in.phone_number)
        if existing:
            raise HTTPException(
    ...
    def get_customer_by_phone(self, phone_number: str) -> Optional[Customer]:
        ...
        """
        return self.repository.get_by_phone_number(phone_number)
    ...
    def update_customer(self, customer_id: int, customer_in: CustomerUpdate) -> Customer:
        ...
        # If phone_number is changing, verify uniqueness
